...
<Tip>
  You can use Traceloop whether you use a framework like LangChain, or directly
  interact with a foundation model API.
</Tip>

```python
Tracer.init(app_name="joke_generation_service")
...
<CardGroup>
  ...
  <Card title="Advanced Configurations" icon="code" href="/python-sdk/advanced">
