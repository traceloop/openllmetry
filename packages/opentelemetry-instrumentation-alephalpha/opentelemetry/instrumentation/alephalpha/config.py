...
# Configure a logger for handling exceptions
exception_logger = logging.getLogger("AlephAlphaInstrumentation")
exception_logger.setLevel(logging.ERROR)

# Configure logging output (console in this example)
handler = logging.StreamHandler()
formatter = logging.Formatter('%(asctime)s - %(name)s - %(levelname)s - %(message)s')
handler.setFormatter(formatter)
exception_logger.addHandler(handler)

# Assign the configured logger to Config.exception_logger
class Config:
        ...
        def wrapper(wrapped, instance, args, kwargs):
            try:
                ...
                if Config.exception_logger:
                    Config.exception_logger.error("An error occurred in instrumentation", exc_info=True)
                raise e
...
class AlephAlphaInstrumentor(BaseInstrumentor):
    ...
    def __init__(self, exception_logger=None):
        super().__init__()
        Config.exception_logger = exception_logger or Config.exception_logger
