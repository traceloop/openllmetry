...
def test_prompt_management_with_tools(exporter, openai_client):
    ...
    open_ai_span = spans[0]
    assert open_ai_span.attributes.get("traceloop.prompt.key") == "joke_generator"
    assert open_ai_span.attributes.get("traceloop.prompt.version") == "clpuabf780000106giwxkinpq"
    assert open_ai_span.attributes.get("traceloop.prompt.version.hash") == "8296b2fe"
    assert open_ai_span.attributes.get("traceloop.prompt.version.version") == 0
    assert open_ai_span.attributes.get("traceloop.prompt.version.name") == "dfgdfg"
    assert open_ai_span.attributes.get("traceloop.prompt.version.provider") == "openai"
    assert open_ai_span.attributes.get("traceloop.prompt.version.templating_engine") == "jinja2"
    assert open_ai_span.attributes.get("traceloop.prompt.version.messages") == [
        {
            "role": "user",
            "index": 0,
            "template": "Tell me a joke about OpenTelemetry, {{style}} style",
    ...
    assert open_ai_span.attributes.get("traceloop.prompt.version.llm_config.tool_choice") == "required"
    assert open_ai_span.attributes.get("traceloop.prompt.version.llm_config.tools") == [
        {
            "type": "function",
            "function": {
                "name": "get_joke",
