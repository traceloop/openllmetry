...
Tests all built-in condition functions.
...
"""
from traceloop.sdk.guardrail.condition import (
    is_true,
    is_false,
    equals,
    greater_than,
...
class TestConditionGreaterThanOrEqual:
    """Tests for greater_than_or_equal()."""
    ...
    def test_gte_with_integer(self):
        ...
        condition = greater_than_or_equal(50)
...
class TestConditionLessThanOrEqual:
    ...
    def test_lte_with_integer(self):
        ...
        condition = less_than_or_equal(100)
