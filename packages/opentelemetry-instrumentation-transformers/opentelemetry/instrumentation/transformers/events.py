"""Event utilities for Transformers instrumentation."""
...
def prompt_to_event(
    ...
    """Create an event for a Transformers prompt."""
    event_attributes = {
        GenAIAttributes.GEN_AI_SYSTEM: GenAIAttributes.GenAiSystemValues.TRANSFORMERS.value,
...
def completion_to_event(
    ...
    """Create an event for a Transformers completion."""
    event_attributes = {
        GenAIAttributes.GEN_AI_SYSTEM: GenAIAttributes.GenAiSystemValues.TRANSFORMERS.value,
