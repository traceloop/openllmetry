...
def disabled_test_cassio_grpc_retrieval(exporter, openai_client):
    cassio.init(
        api_key=os.getenv("cassio_API_KEY"),
        environment=os.getenv("cassio_ENVIRONMENT"),
    )
    index = cassio.GRPCIndex("gen-qa-openai-fast")
...
@pytest.mark.vcr
def test_cassio_retrieval(exporter, openai_client):
    cassio.init(
        api_key=os.getenv("cassio_API_KEY"),
        environment=os.getenv("cassio_ENVIRONMENT"),
    )
    index = cassio.Index("gen-qa-openai-fast")
