...
def _get_vendor_rules() -> List[VendorRule]:
    ...
    return [
        ...
        VendorRule(
            exact_matches={"ChatOpenAI", "OpenAI", "OpenAIEmbeddings"}, patterns=["openai"], vendor_name="openai"
        ),
        VendorRule(
        ...
        VendorRule(exact_matches={"ChatAnthropic", "AnthropicLLM"}, patterns=["anthropic"], vendor_name="anthropic"),
        VendorRule(
        ...
        VendorRule(
            exact_matches={"ChatGoogleGenerativeAI", "GoogleGenerativeAI", "GooglePaLM", "ChatGooglePaLM"},
            patterns=["google", "palm", "gemini"],
            vendor_name="gcp.gen_ai",
        ),
        VendorRule(
            exact_matches={"ChatCohere", "CohereEmbeddings", "Cohere"}, patterns=["cohere"], vendor_name="cohere"
        ),
        VendorRule(
            exact_matches={
                "HuggingFacePipeline",
        ...
        VendorRule(
            exact_matches={"ChatOllama", "OllamaEmbeddings", "Ollama"}, patterns=["ollama"], vendor_name="ollama"
        ),
        VendorRule(exact_matches={"Together", "ChatTogether"}, patterns=["together"], vendor_name="together_ai"),
        VendorRule(exact_matches={"Replicate", "ChatReplicate"}, patterns=["replicate"], vendor_name="replicate"),
        VendorRule(exact_matches={"ChatFireworks", "Fireworks"}, patterns=["fireworks"], vendor_name="fireworks"),
        VendorRule(exact_matches={"ChatGroq"}, patterns=["groq"], vendor_name="groq"),
        VendorRule(exact_matches={"ChatMistralAI", "MistralAI"}, patterns=["mistral"], vendor_name="mistral_ai"),
    ]
