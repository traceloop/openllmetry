...
async def _aset_token_usage(
    ...
    prompt_tokens = 0
    cache_creation_tokens = response.get("gen_ai.anthropic.usage.cache_creation_input_tokens", 0)
    cache_read_tokens = response.get("gen_ai.anthropic.usage.cache_read_input_tokens", 0)
