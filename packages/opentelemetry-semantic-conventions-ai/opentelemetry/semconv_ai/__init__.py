...
class SpanAttributes:
    ...
    GEN_AI_COMPLETION=GenAIAttributes.GEN_AI_COMPLETION
    GEN_AI_CONVERSATION_ID=GenAIAttributes.GEN_AI_CONVERSATION_ID
    GEN_AI_DATA_SOURCE_ID=GenAIAttributes.GEN_AI_DATA_SOURCE_ID
    GEN_AI_OPENAI_REQUEST_SERVICE_TIER=GenAIAttributes.GEN_AI_OPENAI_REQUEST_SERVICE_TIER
    GEN_AI_OPENAI_RESPONSE_SERVICE_TIER=GenAIAttributes.GEN_AI_OPENAI_RESPONSE_SERVICE_TIER
    GEN_AI_OPENAI_RESPONSE_SYSTEM_FINGERPRINT=GenAIAttributes.GEN_AI_OPENAI_RESPONSE_SYSTEM_FINGERPRINT
    GEN_AI_OUTPUT_TYPE=GenAIAttributes.GEN_AI_OUTPUT_TYPE
    GEN_AI_PROMPT=GenAIAttributes.GEN_AI_PROMPT
    GEN_AI_REQUEST_CHOICE_COUNT=GenAIAttributes.GEN_AI_REQUEST_CHOICE_COUNT
    GEN_AI_REQUEST_ENCODING_FORMATS= GenAIAttributes.GEN_AI_REQUEST_ENCODING_FORMATS
    GEN_AI_REQUEST_FREQUENCY_PENALTY= GenAIAttributes.GEN_AI_REQUEST_FREQUENCY_PENALTY
    ...
    GEN_AI_REQUEST_PRESENCE_PENALTY=GenAIAttributes.GEN_AI_REQUEST_PRESENCE_PENALTY
    GEN_AI_REQUEST_SEED=GenAIAttributes.GEN_AI_REQUEST_SEED
    GEN_AI_REQUEST_STOP_SEQUENCES=GenAIAttributes.GEN_AI_REQUEST_STOP_SEQUENCES
    ...
    GEN_AI_SYSTEM=GenAIAttributes.GEN_AI_SYSTEM
