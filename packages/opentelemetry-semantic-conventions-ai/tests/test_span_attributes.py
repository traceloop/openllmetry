"""
Tests for SpanAttributes and GenAISystem enum values.

Verifies that attribute string values match OTel GenAI semantic conventions
(https://opentelemetry.io/docs/specs/semconv/gen-ai/) and project policy.
"""
