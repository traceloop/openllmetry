...
def process_message(chat_id: str, user_message: str, conversation_history: list) -> tuple[str, list]:
    ...
    # Set chat_id as an attribute on the current span for association
    tracer = trace.get_tracer(__name__)
    current_span = trace.get_current_span()
    if current_span:
        current_span.set_attribute("chat_id", chat_id)
        current_span.set_attribute("association.properties.chat_id", chat_id)
