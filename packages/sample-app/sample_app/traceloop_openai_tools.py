...
def travel_planning_agent(user_request: str) -> str:
    ...
    try:
        ...
        log_action("travel_agent", "completed", {"tools_used": len(
            [msg for msg in conversation if msg.get("role") == "tool"])})
...
if __name__ == "__main__":
    travel_request = (
        "Plan a 4-day trip to Tokyo in April 2025. I'm interested in "
        "technology, food, and traditional culture. Find flights from "
        "San Francisco and recommend hotels."
    )
