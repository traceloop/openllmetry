...
ACTION_ATTRIBUTES = {
    "app.governance.action.ref": "tool:crm.update_customer",
    "app.governance.action.hash": (
        "sha256:6f1f2d8a3c8c9e7a0b4d5e6f7890abcd1234567890abcdef1234567890abcdef"
    ),
    "app.governance.verdict": "allow",
    "app.governance.approval.status": "approved",
    "app.governance.proof.url": "https://governance.example/proofs/run-9b7c/action-42",
    "app.governance.external_verifier.ref": "verifier://policy-engine/prod/decision-42",
}
...
def main():
    ...
    with tracer.start_as_current_span("agent.action") as span:
        ...
        # Run the approved action here. A governance gateway can provide these
        # values before the action is executed.
