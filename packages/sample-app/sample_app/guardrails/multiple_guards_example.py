...
async def multiple_lambda_guards_example():
    ...
    guardrail = client.create_guardrail(
        ...
        on_failure=raise_exception("Content failed validation checks"),
        parallel=True,
    )
...
async def mixed_guard_types_example():
    ...
    guardrail = client.create_guardrail(
        ...
        on_failure=raise_exception("Response failed safety or business rules"),
    )
...
async def sequential_guards_example():
    ...
    guardrail = client.create_guardrail(
        ...
        on_failure=raise_exception("Sequential validation failed"),
