...
def test_new_assistant(
    ...
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_INPUT_TOKENS] == 145
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_OUTPUT_TOKENS] == 155
...
def test_new_assistant_with_polling(
    ...
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_INPUT_TOKENS] == 374
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_OUTPUT_TOKENS] == 86
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_SYSTEM] == "openai"
...
def test_existing_assistant(
    ...
    assert open_ai_span.attributes["gen_ai.prompt.2.role"] == "user"
    assert open_ai_span.attributes["gen_ai.prompt.2.content"] == user_message
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_INPUT_TOKENS] == 639
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_OUTPUT_TOKENS] == 170
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_SYSTEM] == "openai"
...
def test_streaming_new_assistant(
    ...
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_INPUT_TOKENS] == 790
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_OUTPUT_TOKENS] == 225
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_SYSTEM] == "openai"
...
def test_streaming_existing_assistant(
    ...
    assert open_ai_span.attributes[f"{SpanAttributes.GEN_AI_PROMPT}.1.role"] == "system"
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_INPUT_TOKENS] == 364
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_USAGE_OUTPUT_TOKENS] == 88
    assert open_ai_span.attributes[SpanAttributes.GEN_AI_SYSTEM] == "openai"
