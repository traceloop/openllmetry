...
from opentelemetry.instrumentation.openai.shared.chat_wrappers import chat_wrapper
from opentelemetry.instrumentation.openai.shared.completion_wrappers import completion_wrapper
